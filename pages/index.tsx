...
export default function Home() {
  return (
    <div className="container w-[50%]  mx-auto">
      ...
      <main className="border-y border-slate-200 py-4">
        <div className="prose   ">
          <Link href="/posts">
            <h2 className="text-zinc-700 text-[1.8rem] m-0 mt-10 tracking-wide font-black ">
              Hiking through the woods
            </h2>
          </Link>
          <p className="text-gray-500">Jan 08,2019</p>
          <p className="font-serif text-[18px]  ">
            This is RichText that includes both external links and links to
            internal documents. They should be handled intelligently or
            everything might break. Don't forget about media too! Do your best
            to solve this using HTML Serializer. We shall now test image links
            as well:
          </p>
        </div>
        <div className="prose   ">
