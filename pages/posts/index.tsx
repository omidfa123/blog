  ...
  return (
    <div className="container w-[700px] mx-auto mt-20">
      ...
      <div className="prose mb-5">
        <h1 className="text-5xl font-back text-zinc-800 ">
          Hiking through the woods
        </h1>
        <p className="text-zinc-600 font-serif text-[18px]">
          This is RichText that includes both external links and links to
          internal documents. They should be handled intelligently or everything
          might break. Don't forget about media too! Do your best to solve this
          using HTML Serializer.
        </p>
        <p className="text-zinc-600 font-serif  text-[18px]">
          We shall now test image links as well:
        </p>
      </div>
      <div className="prose mb-10">
        <Image src={post} layout={'responsive'} />
        <p className="italic m-0 mt-2 text-sm text-zinc-500 text-center">
          Don't ask how I got this shot
        </p>
      </div>
      <div className="border-b border-slate-200 pb-10">
        <h2 className="text-zinc-600 italic text-3xl translate-x-[-127px] mb-6 ">
        ...
        <p className="font-srif tracking-wide text-zinc-600">
          ...
          hendrerit, sint option euripidis vel te. Impedit veritus qui eu, vel
          modo accusam at. Te dicit accusamus mea, alia omnium no est. Mea cu
          possit invidunt complectitur, sea omnis vivendum ne. Eros dictas
          assentior ne qui. At has aperiam reformidans. Rebum choro imperdiet ex
          mei. Ea vide elit percipit mel, id eam invidunt vituperatoribus.
          Munere temporibus consequuntur no sit. Justo utroque dissentias at
          est, possim dolorem assueverit eam ut. Te erat illud aperiri est. Cu
          duo sanctus scriptorem, nam te habeo fuisset quaestio. Eam et error
          simul. Ferri utamur instructior vim in, ei per mazim congue, nusquam
          vituperatoribus eos an. Ne mea salutatus vulputate. Tota tractatos
          argumentum vis te. Et iusto nostrud vel, cu vis regione virtute. Malis
          errem ex quo, an est percipitur dissentias. Te facer primis alterum
          vel. Tale senserit sadipscing qui et. Prima fabellas facilisis at has.
